        ...
        if (jsonArray != null) {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                try {
                    ...
                    ParseQuery queryTwo = ParseQuery.getQuery("Comment");
                    queryTwo.whereEqualTo("objectId", id);
                    ParseObject parseObjectQuery = queryTwo.getFirst();
